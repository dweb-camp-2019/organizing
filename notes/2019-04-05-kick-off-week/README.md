...
Emphasizing nourishment & self-care as a core part of our exploration into the Decentralized Web and planning explicit relaxation times for participants remind of holistic approaches from [Holistic Security](https://holistic-security.tacticaltech.org/introduction.html) and the [6-2-1 Rule](https://events.ccc.de/congress/2018/wiki/index.php/File:SleepEatShower.svg) at Congress.
...
We all do not want DWeb Camp 2019 to feel exclusive, and want to take explicit efforts for diversity in gender and disciplines with global representation.
In addition to reflecting on Summit 2018 efforts, we also looked to [ScuttleCamp](https://github.com/dweb-camp-2019/organizing/issues/53) and [received input from its organizers](https://github.com/dweb-camp-2019/organizing/blob/master/notes/2019-04-10-scuttlecamp-exchange-call.md), and spoke with groups that work with communities that are traditionally under-represented in our digital ecosystems.

All the groups we spoke with shared how curating for diversity & inclusion takes explicit effort and their strategies toward this difficult problem.
For example, in speaking with [Internet Society](https://www.internetsociety.org) and Nico Pace from [Association for Progressive Communications](http://apc.org) and [AlterMundi](http://altermundi.net), we recognized that inviting community representatives from the Global South is high effort, not only for cost (USD 5,000+ for people from remote regions), but also the time to apply for travel visas and how often times visitors are mistreated in the process.
This reminded of the [thoughts shared by kopek and Will Scott during their 34c3 talk (around the 39-minute mark)](https://media.ccc.de/v/34c3-8740-the_internet_in_cuba_a_story_of_community_resilience#t=2341).
Nonetheless, it is highly valuable to bring in perspectives who can speak to their struggles where their small community is 1000 km away from the nearest Internet connection point, and how communication infrastructure is highly coupled to power independence as power isn't reliable in the first place, and the interdependence processes these small communities may have because not every region has a single network operator. Having these representations will be truly invaluable to help us unpack the any _layers_ of decentralizations.

Given the limited budget of DWeb Camp, we realistically cannot support too many travel stipends, but we are reaching out to specific organizations currently working with target groups to try and diversify perspectives. We also spoke a lot about focusing efforts on _meaningful engagements_ for the people we manage to invite, and move to a culture that values diverse skillsets and perspectives equally where diverse representations will naturally emerge.

Following the process employed at Summit 2018, we went through a list of 300+ people from 2018 that was put together by various contributors, had 2019 organizers append to that list, discussed specifically about how some of those individuals may help broaden the diversity and foster the inclusive space that we want.
We are in an ongoing process to come up with a subset of those individuals where we will make extra effort to reach out and help make it possible for them to participate at Camp 2019.

These only capture part of the discussions that led to the drafting and outcomes of our _First Principles_, you can look at our [current draft](https://github.com/dweb-camp-2019/communication/issues/7) for details and add comments.
...
In 2018, participants represented multiple disciplines and efforts were made to broaden gender diversity.
